...
CREATE TABLE `credit_card_info` (
  `idcredit_card_info` int(11) NOT NULL,
  ...
  UNIQUE KEY `credit_card_infocol1_UNIQUE` (`number`)
...
-- Dump completed on 2015-08-12 18:45:42
